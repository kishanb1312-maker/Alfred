...
# /warmapply-research — company-research only
...
2. **Invoke** the `warmapply:company-research` subagent → for each fresh job: company analysis, a
   verified contact email via the WarmApply waterfall, and a 0–100 match score. Drop jobs below
